...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        {!! Form::open(['method' => 'POST',  'route' => ['cost.store'], 'enctype' => 'multipart/form-data']) !!}
        @csrf
            <div class="row">
                <div class="col-md-6">
                    <!-- /.form-group -->
        ...
        <div class="box-footer">
            <a href=" {{ route('cost.index') }}" class="btn btn-warning" style="margin-left: 15px; margin-bottom: 50px;">Hủy</a>
